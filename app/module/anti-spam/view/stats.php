...
$auto_spammed = $wpdb->get_var( "SELECT COUNT(*) FROM {$table_blogs} WHERE spammed_date > '1970-01-01'" );
...
<div class="wrap">
	...
	<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 30px;">
		...
		<div class="postbox">
			...
			<div class="inside">
				<table class="wp-list-table widefat">
					<tr><td><?php _e( 'Verfolgte IPs:', 'cpsec' ); ?></td><td><strong><?php echo number_format_i18n( $wpdb->get_var( "SELECT COUNT(*) FROM {$table_ips}" ) ); ?></strong></td></tr>
